...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cirrus', 1, 'Cirrus is one of the most common types of clouds that can be seen at any time of the year. They’re thin and wispy with a silky sheen appearance.', 23.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cirrocumulus', 1, 'Cirrocumulus clouds exhibit features from both cumulus and cirrus clouds but should not be confused with altocumulus clouds. While the two can look similar, cirrocumulus does not have shading and some parts of altocumulus are darker than the rest. Cirrocumulus cloud comes after cirrus cloud during warm frontal system.', 12.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cirrostratus', 2, 'Cirrostratus clouds have a sheet-like appearance that can look like a curly blanket covering the sky. They’re quite translucent which makes it easy for the sun or the moon to peer through. Their color varies from light gray to white and the fibrous bands can vary widely in thickness. Purely white cirrostratus clouds signify these have stored misture, indicating the presence of a warm frontal system.', 24.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Altocumulus', 2, 'Altocumulus clouds form at a lower altitude so they’re largely made of water droplets though they may retain ice crystals when forming higher up. They usually appear between lower stratus clouds and higher cirrus clouds, and normally precede altostratus when a warm frontal system is advancing.', 9.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Altostratus', 2, 'They’re uniformly gray, smooth, and mostly featureless which is why they’re sometimes called ‘boring clouds’. You’ll commonly see this types of clouds in an advancing warm frontal system, preceding nimbostratus clouds.', 24.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Nimbostratus', 2, 'The name Nimbostratus comes from the Latin words nimbus which means “rain” and stratus for “spread out”. These gloomy clouds are the heavy rain bearers out there forming thick and dark layers of clouds that can completely block out the sun. Though they belong to the middle-level category, they may sometimes descend to lower altitudes.', 22.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Stratus', 3, 'Stratus clouds are composed of thin layers of clouds covering a large area of the sky. This is simply mist or fog when it forms close to the ground.',12.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cumulus', 3, 'The most recognizable out of all the types of clouds. These adorable ‘piles of cotton’ form a large mass with a well-defined rounded edge.',13.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cumulonimbus', 3, 'Cumulonimbus is fluffy and white like cumulus but the cloud formations are far larger. It’s a vertical developing type of cloud whose base grows from one to up to eight kilometers, hence it’s commonly called a tower cloud.',13.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Stratocumulus', 3, 'Stratocumulus looks like a thick white blanket of stretched out cotton.',14.00);
